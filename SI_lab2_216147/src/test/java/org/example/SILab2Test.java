...
class SILab2Test {
    User user1 = new User("aaaa","AAA","asdasd@asd.com");
    User[] users = new User[]{new User("aaaa","aaaa123","asdasd@asd.com")};

    User user2 = new User(null,"tikva123#","adads@asd.com");
    User user3 = new User("Dare","aadss123","nevalidenemail");
    User user4 = new User("Dare","asdasd asd","nevalidenemail");
